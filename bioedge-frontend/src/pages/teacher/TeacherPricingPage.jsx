...
export const TeacherPricingPage = () => {
  const { course, updateCourse, availableSeats, activeStudentsCount } = useCourseData();
  const [saved, setSaved] = useState(false);
  const [monthlyFee, setMonthlyFee] = useState(course.monthlyFee);
  const [fullCourseFee, setFullCourseFee] = useState(course.fullCourseFee);
  const [seatLimit, setSeatLimit] = useState(course.seatLimit);
  const [whyLimitedSeats, setWhyLimitedSeats] = useState(course.whyLimitedSeats);
        ...
        <div className="seat-formula-card bio-card">
          ...
          <div className="formula-box">
            ...
            <div className="formula-item highlight">
              ...
              <strong className="formula-res">{Math.max(0, seatLimit - activeStudentsCount)} Remaining</strong>
            </div>
          </div>
          ...
          <div className="public-display-preview">
            ...
            <div className="preview-bubble">
              ...
              <strong>Only {Math.max(0, seatLimit - activeStudentsCount)} seats remaining</strong>
            </div>
