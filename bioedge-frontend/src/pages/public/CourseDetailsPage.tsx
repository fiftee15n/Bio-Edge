  ...
  return (
    <div className="course-details-page-wrapper section-padding">
      <div className="container">
        ...
        {/* Full-Width Tab Content Section */}
        <div className="course-fullwidth-section">
          ...
          {/* TAB 1: OVERVIEW */}
          {activeTab === 'overview' && (
            <div className="tab-pane-card bio-card fullwidth-pane">
        ...
        {/* Aligned Bottom Pricing & Enrollment Action Card (Full Width Below) */}
        <div className="course-bottom-pricing-card bio-card">
          
          <div className="b-pricing-col-main">
            <span className="b-pricing-label">Alpha Cohort Tuition</span>
            <div className="b-price-display">
              <span className="cur">৳</span>
              <span className="num">12,500</span>
              <span className="period">/ 4-Month Full Course</span>
            </div>
            <span className="b-installment-note">or ৳3,500 per month (4 monthly installments)</span>
            <div className="b-guarantee-pill">
              <ShieldCheck size={15} /> 7-Day Satisfaction Guarantee
            </div>
          </div>

          <div className="b-pricing-col-actions">
            <div className="b-seats-banner">
              <span className="pulse-dot"></span>
              <span>{availableSeats} Seats Remaining in Alpha Batch</span>
            </div>
            <div className="b-action-buttons-group">
              <Link 
                to="/enroll?course=alpha-cohort"
                className="btn btn-primary btn-lg b-enroll-cta"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="btn btn-outline btn-lg b-whatsapp-cta"
              >
          ...
          <div className="b-pricing-col-perks">
            <strong className="b-perks-title">What's Included:</strong>
            <ul className="b-perks-list">
              <li><Check size={15} /> 48 Live Interactive Sessions</li>
              <li><Check size={15} /> 24 Botany & Zoology Chapters</li>
              <li><Check size={15} /> Line-by-Line CQ Paper Grading</li>
              <li><Check size={15} /> 80+ Annotated Diagram Notebook PDF</li>
              <li><Check size={15} /> 1080p Recorded Session Library</li>
            </ul>
          </div>
      ...
      <style>{`
        ...
        /* Full Width Aligned Bottom Pricing & Enrollment Card */
        .course-bottom-pricing-card {
          display: grid;
